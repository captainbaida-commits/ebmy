...
CHECK_INTERVAL = int(os.getenv("CHECK_INTERVAL", "20"))  # не используется, но оставлено
...
if __name__ == "__main__":
    send_telegram_message("🚀 Бот для eBay США запущен. Интервал 20-32 сек, команды /stop /start")
